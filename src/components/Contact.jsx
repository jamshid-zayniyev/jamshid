    ...
    <div>
        ...
        <div className='max-w-[700px] w-full m-auto'>
           <div className='flex flex-wrap justify-center items-center gap-5 md:gap-10 my-5'>
            <a href='https://www.linkedin.com/in/jamshid-zayniev-091b66266/' target='blank' className='flex min-w-[300px] h-[70px] px-10 justify-start gap-2 items-center bg-[#fef4f5] rounded-[10px] shadow-md hover:shadow-lg cursor-pointer'>
                <img src={LinkedIn} alt="Telegram" className='w-[50px]' />
                <span className='text-[#5e6064]'>in/ekaterina-kutovaya</span>
            </a>
            <a href='https://t.me/jamzayn10' target='blank' className='flex min-w-[300px] h-[70px] px-10 justify-start gap-2 items-center bg-[#fef4f5] rounded-[10px] shadow-md hover:shadow-lg cursor-pointer'>
